export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>Effective Date: 12 Sep 2023</p>
      <p>
        At Convertify, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          data we collect, please contact us at: xxxxxxxxx@gmail.com
        </p>
      </div>

      <p>
        By using Convertify, you agree to the practices outlined in this Privacy
